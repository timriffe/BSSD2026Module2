...
Issue with 1975: The deviation in TFR is indeed small; this is coming from the HMD documentation, where we see that there was a universe definition change in that year, which stifles exposure calculations. The HMD has a slick way to account for this, but we don't have the info handy that we'd need.
